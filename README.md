...
Jupyter code to read files in GFE format and to generate a sample GFE data file is also included, as is a Jupyter script which converts fireball single-station observations between formats.
